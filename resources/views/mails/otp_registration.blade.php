...
@section('content')
  <div class="container flex flex-col items-center justify-center h-full py-10 backdrop-blur-lg">
    <div class="h-full w-[90%] py-2 px-3 rounded bg-white border-[1px] border-gray-200 text-sm text-justify flex flex-col gap-3">
      <p>Selamat datang teman UMKM,</p>
      <p>OTP Anda adalah: </p>
      <div class="flex justify-center w-full py-3 text-4xl font-bold tracking-[1rem] text-tertiary">
        {{ $otp }}
      </div>
      <p>Gunakan OTP ini untuk melanjutkan pendaftaran Anda. OTP hanya berlaku selama 5 menit, sampai dengan
      ...
      <p> Jika Anda tidak mengenali atau tidak melakukan pendaftaran, harap diabaikan pesan ini.</p>

      <hr class="bg-black">
      <div class="flex flex-col items-center gap-3">
        <h1 class="text-xs font-light text-center">Hubungi kami melalui</h1>
